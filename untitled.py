...
Original file is located at
    https://colab.research.google.com/drive/10dZeH6kWEdRQOD178lZCU7DXE2jrGOzG
"""
...
# Changed to a text generation model
model_name = "gpt2"  # Replace with a valid model name from Hugging Face, e.g., "gpt2"
